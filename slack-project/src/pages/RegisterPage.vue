        ...
        <router-view />
            ...
            <q-form class="flex flex-center" style="min-height: 90vh;">
                <div class="q-gutter-md" style="max-width: 300px; width: 100%;" @submit.prevent="onSubmit">
                    ...
                    <q-input class="q-mb-sm" standout="bg-primary text-white" v-model="firstName" label="First name" />

                    <q-input class="q-mb-sm" standout="bg-primary text-white" v-model="lastName" label="Last name" />

                    <q-input class="q-mb-sm" standout="bg-primary text-white" v-model="username" label="Username" />

                    <q-input class="q-mb-sm" standout="bg-primary text-white" v-model="email" label="Email" />

                    <q-input class="q-mb-sm" :type="visiblePassword ? 'text' : 'password'" standout="bg-primary text-white" v-model="password" label="Password" >
                        <template v-slot:append>
                            <q-icon :name="visiblePassword ? 'visibility' : 'visibility_off'" @click="togglePasswordVisibility" class="cursor-pointer"/>
                        </template>
                    </q-input>
